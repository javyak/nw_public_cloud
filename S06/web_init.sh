...
sudo wget https://raw.githubusercontent.com/javyak/nw_public_cloud/master/S04/index.html
...
sudo wget https://raw.githubusercontent.com/javyak/nw_public_cloud/master/S04/regportal_ssl
